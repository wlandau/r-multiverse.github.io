...
In the `REAMDE` of your package, it is good practice to include installation instructions ([example](https://github.com/tidyverse/dplyr/blob/main/README.md#installation)).
