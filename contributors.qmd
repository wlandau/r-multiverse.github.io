...
An automated process periodically scans each new pull request to <https://github.com/r-releases/contributions>. Depending on the results of the automated checks, the bot automatically merges the pull request, closes it, or flags it for manual review. In the latter case, an R-releases moderator will manually review your pull request and contact you if there are questions. Please see our [review policy](https://r-releases.github.io/review.html) for more information about the process.
