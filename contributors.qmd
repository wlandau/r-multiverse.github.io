...
For the one-time registration process:
...
For each contributed text file:
  ...
  - The file should contain a single line with the package URL. [Example](https://github.com/r-releases/contributions/blob/main/packages/gh): https://github.com/r-lib/gh
