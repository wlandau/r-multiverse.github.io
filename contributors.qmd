...
1. Navigate to <https://github.com/r-releases/contributions>.
2. Open a [GitHub pull request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-pull-requests) to add one or more listings to the [`packages` folder](https://github.com/r-releases/contributions/tree/main/packages).

Watch this 1-minute video to learn how:

{{< video https://vimeo.com/923333903 title="R-releases contribution tutorial" >}}
...
2. The file contains a single line with the package URL. [Example](https://github.com/r-releases/contributions/blob/main/packages/gh): https://github.com/r-lib/gh
