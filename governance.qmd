...
All repositories are open to everyone, with the exception of a private repository where security and conduct-related matters are shared between the administrators only.
...
They have the right to cast votes on all proposals on community-related decisions, the right to appoint moderators, and the right to change the composition of the RMC itself.
...
Communication is always done publicly via GitHub.
There are no private mailing lists and all decisions related to the project are made in public.
