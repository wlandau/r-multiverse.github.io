...
To reach Production, a package release must pass the following checks:
...
* `R CMD check` must pass in the [Staging universe](https://staging.r-multiverse.org) (no errors or warnings) on Mac (R-release), Windows (R-release), Linux (R-devel).
