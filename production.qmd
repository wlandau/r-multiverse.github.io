...
text <- c(
  ...
  "  \"polars\",",
  "  repos = c(",
  sprintf("    \"https://production.r-multiverse.org/%\",", snapshot()$snapshot),
...
It includes the start date of each phase of [Staging](#staging) and the compatible version of base R.
